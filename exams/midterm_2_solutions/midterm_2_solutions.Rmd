...
a. (3) Write the mathematical formula for the conditional probability function $p(X)$ for this model.

b. (2) Write an R function which takes as input the values of the predictors `X1` and `X2` and outputs the conditional probability that $Y$ takes the value $1$, given those values. Plot the values of your probability function for the simulated data.
