...
In this problem, you will simulate data from a *logistic regression* model. It may be helpful to reference the code from Lab 2 that we used to simulate from a least squares regression model.
